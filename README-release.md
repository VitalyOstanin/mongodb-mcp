...
This document outlines the complete release procedure for the MongoDB MCP project. Follow these steps in order to ensure a clean, validated release.
...
The MongoDB MCP project uses **automated CI/CD via GitHub Actions** for releases:
...
### Added
- Collection schema analysis (#15)
- MongoDB connection management (#12)
...
**Expected output:**
```
PASS src/mongodb-client.test.ts
...
...
2. Add Secret to GitHub:
   - Go to your GitHub repository: https://github.com/VitalyOstanin/mongodb-mcp
...
1. **Check GitHub Actions workflow:**
   - Go to: https://github.com/VitalyOstanin/mongodb-mcp/actions
   - Look for "Publish to npm" workflow run
   - Verify all steps completed successfully

2. **View created release:**
   - Go to: https://github.com/VitalyOstanin/mongodb-mcp/releases
...
# Or visit in browser:
# https://github.com/VitalyOstanin/mongodb-mcp/actions/workflows/publish.yml
```
...
npm view @vitalyostanin/mongodb-mcp version

# Expected output: 0.x.x (matching your release tag)

# View full package info
npm view @vitalyostanin/mongodb-mcp

# Check package provenance (cryptographic signature)
npm view @vitalyostanin/mongodb-mcp --json | grep -i provenance
```
...
```bash
# Visit releases page
# https://github.com/VitalyOstanin/mongodb-mcp/releases/latest
